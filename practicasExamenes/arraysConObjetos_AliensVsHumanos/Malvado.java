...
public class Malvado {
	 ...
	 */
	public Malvado(String nombre, int puntosVida, boolean vivo, int contadorDisparos) {
		super();
		this.nombre = nombre;
	...
	public String toString() {
		return "Malvado [nombre=" + nombre + ", puntosVida=" + puntosVida + ", vivo=" + vivo + ", contadorDisparos="
				+ contadorDisparos + "]";
	}
